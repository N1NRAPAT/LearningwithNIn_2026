...
{
    if (status == 1)
        printf("Type 1 : Full Order\n");
    else if (status == 2)
        printf("Type 2 : Product + Order ID\n");
    else if (status == 3)
        printf("Type 3 : Customer + Product\n");
    printf("-------------------------\n");
    if (strlen(order->customer_name) > 0)
        printf("Customer Name : %s\n", order->customer_name);
    else
        printf("Customer Name : (not provided)\n");
    if (order->order_id != 0)
        printf("Order ID      : %d\n", order->order_id);
    else
        printf("Order ID      : (not provided)\n");
